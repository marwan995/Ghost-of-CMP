...
class Winstate: public our::State {
    ...
    void onInitialize() override {
        ...
        highlightMaterial->tint = glm::vec4(0.4f, 0.0f, 0.8f, 1.0f);
        ...
        buttons[0].position = {475.0f,  495.0f};
        buttons[0].size = {360.0f, 70.0f};
        buttons[0].action = [this](){this->getApp()->changeState("play");};

        buttons[1].position = {560.0f, 595.0f};
        buttons[1].size = {180.0f, 50.0f};
